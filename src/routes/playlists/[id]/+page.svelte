...
<div class="p-4 pb-24 sm:p-6">
	...
	{:else if playlist}
		<div class="mb-8 flex flex-col items-center gap-6 sm:flex-row sm:items-start">
			<div class="h-40 w-40 flex-shrink-0 overflow-hidden rounded-lg bg-surface shadow-lg">
			...
			<div class="text-center sm:text-left">
				...
				{#if tracks.length > 0}
					<button
						...
						class="mt-4 flex items-center gap-2 rounded-full bg-accent px-5 py-2 text-sm font-medium text-accent-text transition-colors hover:bg-accent-hover"
					>
