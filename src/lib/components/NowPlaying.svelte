...
{#if player.showNowPlaying && player.currentTrack}
	...
	<div class="fixed inset-0 z-50 flex flex-col overflow-hidden text-white" style="padding: env(safe-area-inset-top, 0px) env(safe-area-inset-right, 0px) env(safe-area-inset-bottom, 0px) env(safe-area-inset-left, 0px);">
